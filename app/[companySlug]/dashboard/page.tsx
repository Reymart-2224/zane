...
const logout = () => {
  ...
  const companySlug = client?.companySlug || slugify(client?.company_name || "");
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#f8fafc] text-[#111827]">
      <header className="border-b border-gray-200 bg-white">
        <div className="mx-auto flex w-full max-w-[1700px] flex-col gap-4 px-4 py-6 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-400">
              Client Portal
            </p>

            <h1 className="mt-1 text-2xl font-bold text-[#1d2b35] md:text-3xl">
              {client.company_name}
            </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={logout}
              className="rounded-full bg-[#296589] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90"
            >
              Logout
            </button>
          </div>
      ...
      <section className="w-full flex-1">
        <div className="mx-auto w-full max-w-[1700px] px-4 py-6">
          <div className="rounded-[28px] border border-[#ecf6f4] bg-white p-6 shadow-sm">
            <div className="flex flex-wrap gap-3 border-b border-[#ecf6f4] pb-4">
              <TabButton
                label="Listings"
            ...
            <div className="pt-6">
                ...
                <div className="space-y-5">
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <button
                      ...
                      className="w-fit rounded-full bg-[#296589] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90"
                    >
                  ...
                  {showListingForm && (
                    <form
                      ...
                      className="rounded-[24px] border border-blue-100 bg-[#f6fbff] p-6"
                    >
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-1 md:col-span-2">
                          ...
                          <p className="text-[11px] text-gray-400">
                            You can select multiple images. Maximum file size
                            per image: {MAX_IMAGE_SIZE_MB}MB
                          </p>
                      ...
                      <div className="mt-6 flex justify-end gap-3">
                        <button
                          ...
                          className="rounded-full border border-blue-100 bg-white px-5 py-3 text-sm font-semibold text-gray-500 transition hover:bg-blue-50"
                        >
                          Cancel
                        </button>
                  ...
                  <div className="overflow-x-auto rounded-3xl border border-[#ecf6f4]">
              ...
              {activeTab === "account" && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-[24px] border border-blue-100 bg-[#f6fbff] p-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <InfoCard
                        label="Company Name"
                      ...
                      <div className="rounded-2xl bg-white p-4 md:col-span-2">
                        ...
                        <p className="mt-1 text-sm font-semibold text-[#1d2b35]">
                          {client.address || "-"}
                        </p>
                      </div>
                    </div>
